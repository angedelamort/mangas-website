...
/**
 * FROM: https://github.com/vladimmi/construct-static/
 * Reason: no actual package, just dev version.
 */
...
class ConstructStatic
{
    ...
    private function callConstruct($className)
    {
        ...
        if ($reflectionClass->hasMethod('__constructStatic')) {
            ...
            if ($reflectionMethod->isStatic() && $className === $reflectionMethod->getDeclaringClass()->getName()) {
